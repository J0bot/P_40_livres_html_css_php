...
(3, 'Norse Mythology', 3, 3, 3, 2017, 'In Norse Mythology, Gaiman stays true to the myths in envisioning the major Norse pantheon: Odin, the highest of the high, wise, daring, and cunning; Thor, Odin\'s son, incredibly strong yet not the wisest of gods; and Loki - son of a giant - blood brother to Odin and a trickster and unsurpassable manipulator.', '', 304, 'NorseMythology.jpg', NULL, 'English', 1),
(4, 'Goosebumps : Welcome to dead house', 4, 4, 4, 1992, 'The book follows Amanda and Josh Benson, who move with their parents into a creepy old house located in the strange town of Dark Falls where people are unlike any they have known before.', '', 128, 'WelcomeToDeadHouse.jpg', NULL, 'English', 1),
(5, 'Just Kids', 5, 5, 5, 2010, 'Just Kids tells of the bond between two people forged during an innocent time that changed both of their lives. When they met, they were young naïve children. Over time, they grew up into successful adults who together helped shape an entire artistic era.', '', 278, 'JustKids.jpg', NULL, 'English', 1);
