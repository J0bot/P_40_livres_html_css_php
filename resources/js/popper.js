//J'ai download le css et le javascript pour améliorer les performances, et j'ai ensuite rendu le code lisible
function Pop()
{
    var cssRuleFile="resources/css/popup.css";
    ...
    let content=
    {
        message:"Ce site utilise les cookies pour vous donner une meilleure expérience",
        btnText:"Compris !",
        mode:"  banner bottom",
        theme:" theme-classic",
        palette:" palette1",
